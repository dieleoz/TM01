...
# Extract items for ETD/RADAR (System 3)
# Pattern: { item: '3.1.x', ... sistema: 'ETD/RADAR', ... total: '1234.56' }
$pattern = "\{ item: '3\.1\.\d+', .*? sistema: 'ETD/RADAR', .*? total: '([0-9.]+)' \},?"
...
Write-Host "Found $count ETD/RADAR items."
Write-Host "Total Calculated: $total"

# Expected roughly 152,639.21
$expectedLow = 152000
$expectedHigh = 153000
