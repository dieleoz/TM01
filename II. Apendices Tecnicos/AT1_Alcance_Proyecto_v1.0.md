...
- **Manual de Señalización Vial 2015** (Ministerio de Transporte), o la norma que lo modifique o sustituya.
...
Las vías objeto de la concesión PUERTO SALGAR - BARRANCABERMEJA, tienen una longitud total (origen - destino) de **293.0 kilómetros** (259.6 km principales + 33.4 km adicionales en las rutas RN 4510, RN 4511 y RN 4513) y su recorrido discurre entre los departamentos de Cundinamarca, Boyacá y Santander.
...
| **Ramales y Accesos** | INVÍAS | Varios | Varios | 33.40 | Tramos adicionales en RN 4510, 4511 y 4513 según Ingeniería Conceptual |

**Longitud total:** 293.01 km (259.61 + 33.40)
...
|:--------------------|:----------------------|
| **a) Número de calzadas** | Mínimo 2 (1 nueva para completar par vial) |
| **b) Número de carriles por calzada** | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
| **d) Velocidad de diseño** | 100 km/h (80 km/h en zonas restringidas justificadas) |
| **e) Iluminación** | Obligatoria en Peajes, Pesaje, CCO, Áreas de Servicio, Intersecciones, Paraderos y Puentes Peatonales. |
...
|:--------------------|:--------------|:--------------|
| **a) Número de calzadas** | 1 | 1 |
| **b) Número de carriles por calzada** | 2 | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
| **d) Velocidad de diseño** | 100 km/h (ver nota 2) | 100 km/h (ver nota 2) |
| **e) Iluminación** | Obligatoria en Peajes, Pesaje, CCO, Áreas de Servicio, Intersecciones, Paraderos y Puentes Peatonales. | Obligatoria en Peajes, Pesaje, CCO, Áreas de Servicio, Intersecciones, Paraderos y Puentes Peatonales. |
...
|:--------------------|:------------|
| **a) Número de calzadas** | 1 |
| **b) Número de carriles por calzada** | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
| **d) Velocidad de diseño** | 100 km/h (ver nota 2) |
| **e) Iluminación** | Obligatoria en Peajes, Pesaje, CCO, Áreas de Servicio, Intersecciones, Paraderos y Puentes Peatonales. |
| **Radio mínimo (m)** | 394 |
| **Pendiente máxima (%)** | 5 |
...
| Requisitos Técnicos | Subsector 9 |
|:--------------------|:------------|
| **a) Número de calzadas** | 1 |
| **b) Número de carriles por calzada** | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
...
| Requisitos Técnicos | Subsector 10 |
|:--------------------|:-------------|
| **a) Número de calzadas** | 1 |
| **b) Número de carriles por calzada** | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
...
| Requisitos Técnicos | Subsector 12 |
|:--------------------|:-------------|
| **a) Número de calzadas** | 1 |
| **b) Número de carriles por calzada** | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
...
**Tabla 47 – UF13 Características Geométricas y técnicas de Entrega de cada Subsector para vías a cielo abierto, puentes y viaductos**

| Requisitos Técnicos | Subsector 13 |
|:--------------------|:-------------|
| **a) Número de calzadas** | 1 |
| **b) Número de carriles por calzada** | 2 |
| **c) Anchos** | Carril: 3.65 m, Calzada: 7.30 m, Berma interna: 1.00 m, Berma externa: 2.50 m |
...
### Postes SOS
El Concesionario deberá instalar un total de **98 postes de auxilio (SOS)** a lo largo del corredor vial (distribuidos en los 293 km del proyecto), con un espaciamiento máximo de tres (3) kilómetros entre ellos, garantizando la conectividad y disponibilidad del servicio de comunicaciones de emergencia durante toda la etapa de Operación y Mantenimiento.

### Centro de Control Operacional (CCO)
El Centro de Control Operacional principal estará ubicado en **La Lizama PK 4+300 (Ruta Nacional 4513)**, desde donde se centralizará la gestión de todos los sistemas ITS, peajes y atención de emergencias.
