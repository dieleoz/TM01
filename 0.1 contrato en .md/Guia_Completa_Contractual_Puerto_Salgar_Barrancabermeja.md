...
### 1.3 Subdivisiones de la Unidad Funcional 0 (UF0)

| Subdivisión | Descripción | Longitud (km-calzada) | Plazo Indicadores Mínimos | Plazo Indicadores E1-E22, O1-O6 |
|-------------|-------------|----------------------|---------------------------|--------------------------------|
| **UF0-D** | Unidad Funcional 0 Definitiva | 214.68 | 180 días desde Fecha de Inicio | 36 meses desde Fecha de Inicio |
| **UF0-T** | Unidad Funcional 0 Temporal | 152.94 | 180 días desde Fecha de Inicio | Hasta inicio Fase de Construcción de UF correspondiente |
| **UF0-P** | Unidad Funcional 0 Provisional (Pasos Poblados) | 6.62 | 180 días desde Fecha de Inicio | Hasta reversión del Paso Poblado |

**Nota importante**: Los tramos UF0-T dejan de hacer parte de UF0 cuando inicia la Fase de Construcción de la UF a la que pertenecen.

### 1.4 Estaciones de Peaje

| Estación | Ubicación | Segmento | Sentido de Cobro | Observaciones |
|----------|-----------|----------|------------------|---------------|
| **Zambito** | PR 9+200 - Ruta Nacional 4511 | Puerto Boyacá - Puerto Araujo | Bidireccional | Existente |
| **Aguas Negras** | PR 83+900 - Ruta Nacional 4511 | Puerto Araujo - La Lizama | Bidireccional | Debe reubicarse a PR 80+000 según AT1 |

### 1.5 Fases del Contrato

| Etapa | Fase | Descripción | Duración Referencial |
|-------|------|-------------|---------------------|
| **Etapa Preoperativa** | Fase de Preconstrucción | Estudios, diseños, gestión predial, ambiental, social | Según Parte Especial Sección 3.8 |
| **Etapa Preoperativa** | Fase de Construcción | Ejecución de obras de construcción, rehabilitación, mejoramiento | Según Parte Especial Sección 5.2 |
| **Etapa de Operación y Mantenimiento** | - | O&M de todas las UF terminadas | Según Parte Especial |

---

## 2. JERARQUÍA DOCUMENTAL DETALLADA

### 2.1 Fundamento Contractual: Sección 19.15 de la Parte General

**Texto contractual (referencial):**
> "En caso de contradicción entre los documentos que conforman el Contrato, se atenderá al siguiente orden de prelación..."

### 2.2 Orden de Prelación Completo

| Nivel | Documento | Contenido Principal | Aplicación Práctica | Prevalece sobre |
|:---:|-----------|---------------------|---------------------|-----------------|
| **1** | **Contrato Parte General** | Cláusulas generales, definiciones, plazos, obligaciones, penalidades, reversión, mecanismos de solución de controversias | **Supremacía absoluta**. Si contradice cualquier otro documento, siempre prevalece | Todos los demás |
| **2** | **Contrato Parte Especial** | Especificaciones particulares del proyecto: plazos específicos, Unidades Funcionales, estructura tarifaria, cálculo de Retribución, multas específicas | Complementa Parte General con datos específicos de Puerto Salgar-Barrancabermeja | AT1-AT8, AF1-AF3, Oferta, Pliego |
| **3** | **AT1 - Alcance del Proyecto** | Descripción técnica de UF0-UF13, sectores, longitudes, intervenciones, obras especiales obligatorias, sección típica de diseño | Base fundamental de ingeniería y alcance | AT2-AT8, AF1-AF3, Oferta, Pliego |
| **4** | **AT2 - Operación y Mantenimiento** | Especificaciones de O&M, actividades de mantenimiento rutinario/periódico/extraordinario, atención de emergencias, sistemas ITS | Define cómo operar y mantener la vía | AT3-AT8, AF1-AF3, Oferta, Pliego |
| **5** | **AT3 - Especificaciones Técnicas** | Normas técnicas, materiales, procedimientos constructivos, especificaciones INVÍAS aplicables | Detalle técnico de cómo construir | AT4-AT8, AF1-AF3, Oferta, Pliego |
| **6** | **AT4 - Indicadores** | Indicadores E1-E22 (Estado), O1-O6 (Operación), metodología de medición, SICC, tablas de ponderación | Define cómo medir el cumplimiento contractual | AT5-AT8, AF1-AF3, Oferta, Pliego |
| **7** | **AT5 - Interferencia con Redes** | Gestión de redes (eléctricas, telecomunicaciones, acueducto, gas, etc.), traslados, protección, procedimientos | Manejo de interferencias con servicios públicos | AT6-AT8, AF1-AF3, Oferta, Pliego |
| **8** | **AT6 - Gestión Predial** | Adquisición de predios, cronogramas, procedimientos de negociación directa, expropiación, avalúos | Liberación del corredor vial | AT7-AT8, AF1-AF3, Oferta, Pliego |
| **9** | **AT7 - Gestión Ambiental** | Licencias ambientales, PAGA, PMA, Plan de Trámites Ambientales, permisos ambientales | Cumplimiento obligaciones ambientales | AT8, AF1-AF3, Oferta, Pliego |
| **10** | **AT8 - Gestión Social** | PGSC, PGAS, Plan de Reasentamiento, compensaciones sociales, relacionamiento comunitario | Gestión del componente social | AF1-AF3, Oferta, Pliego |
| **11** | **AF1 - Información Financiera** | Modelo financiero, Subcuentas del Patrimonio Autónomo, flujos de caja, proyecciones | Estructura financiera del proyecto | AF2-AF3, Oferta, Pliego |
...
**Enfoque:** Licencias ambientales, PAGA, PMA, cumplimiento de obligaciones ambientales ante autoridades ambientales.
...
**Jerarquía Documental - Uso Neutral:**
...
### CASO 2: Contradicción entre AT1 y AT3 sobre Especificaciones Técnicas
...
**Paso 4:** Lenguaje técnico respectivo
...
**Objetivo:** Verificar que documentos presentados por el Concesionario cumplan con especificaciones contractuales según jerarquía documental.
...
establecido en el AT1 - Sección 2.2.1 (Nivel 3 de jerarquía documental), el cual
...
Procedimientos de mantenimiento rutinario, periódico y extraordinario
...
Durante el periodo reportado NO se registraron hallazgos arqueológicos. Se mantiene el 
...
|---------|----|---------|-----------|-----------------------------|
| 1 | R-014 | Incumplimiento Cierre Financiero | **CRÍTICA** | Gestión intensiva con prestamistas |
| 2 | R-054 | Caducidad del contrato | **CRÍTICA** | Sistema de alertas tempranas de incumplimientos |
| 3 | R-011 | Incumplimiento plazos construcción UF | **MUY ALTA** | Gestión de ruta crítica + recursos suficientes |
| 4 | R-012 | Retrasos adquisición predial | **MUY ALTA** | Inicio temprano + coordinación ANI |
| 5 | R-013 | Retrasos Licencia Ambiental | **MUY ALTA** | Plan robusto + seguimiento ANLA |
| 6 | R-041 | Incompatibilidad de sistemas | **MUY ALTA** | Matriz de trazabilidad + verificación |
| 7 | R-051 | Incumplimiento normativa ambiental | **MUY ALTA** | Cumplimiento estricto AT7 |
| 8 | R-001 | Ejecutar con documento menor jerarquía | **ALTA** | Capacitación + procedimientos |
| 9 | R-003 | Proveedor no cumple especificaciones | **ALTA** | Verificación contractual rigurosa |
| 10 | R-010 | Incumplir 180 días Indicadores Mínimos | **ALTA** | Plan de Puesta a Punto acelerado |

---

## 12. NORMATIVA COLOMBIANA APLICABLE

### 12.1 Normativa de Contratación Estatal

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Ley 80 de 1993** | Estatuto General de Contratación de la Administración Pública | Marco general de contratación estatal aplicable al contrato de concesión |
| **Ley 1150 de 2007** | Normas sobre contratación con recursos públicos | Complementa Ley 80/1993 en aspectos de selección y ejecución |
| **Ley 1508 de 2012** | Régimen jurídico de las Asociaciones Público Privadas (APP) | **Norma específica aplicable** - Art. 11 y 18 sobre APP |
| **Decreto 1082 de 2015** | Decreto Único Reglamentario del Sector Administrativo de Planeación Nacional | Reglamenta procesos de APP, garantías, interventorías |
| **Ley 2020 de 2020** | Ley de Infraestructura - modifica Ley 1508 de 2012 | Actualizaciones al régimen de APP |

### 12.2 Normativa Civil y Comercial

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Código Civil Colombiano** | Art. 1501 (obligaciones implícitas), Art. 1618-1624 (interpretación de contratos) | **Fundamental** para interpretación contractual y obligaciones implícitas |
| **Código de Comercio** | Normas sobre contratos comerciales | Aplicable supletoriamente según Ley 80/1993 |
| **Código Contencioso Administrativo** | Ley 1437 de 2011 | Procedimiento administrativo y jurisdicción contencioso administrativa |

### 12.3 Normativa Técnica Vial

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Manual de Diseño Geométrico de Carreteras - INVÍAS 2008** | Parámetros de diseño geométrico | Aplicable según referencias del AT1 |
| **Especificaciones Generales de Construcción de Carreteras - INVÍAS** | Especificaciones técnicas de construcción | Aplicable según referencias del AT3 |
| **Manual de Señalización Vial - Ministerio de Transporte** | Diseño y especificaciones de señalización | Aplicable según AT2 y AT3 |
| **Resolución de Tarifas de Peaje** | Estructura tarifaria aplicable | Según Parte Especial Sección 4.2 |

### 12.4 Normativa Ambiental

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Ley 99 de 1993** | Ley General Ambiental de Colombia | Marco general de gestión ambiental |
| **Decreto 1076 de 2015** | Decreto Único Reglamentario del Sector Ambiente | Reglamenta licenciamiento ambiental |
| **Resolución 1517 de 2012** | Adopción del Manual de Seguimiento Ambiental | Aplicable al seguimiento de Licencia Ambiental |
| **Resolución 077 de 2012 - ANI** | Programa de Reasentamiento en proyectos de infraestructura | Aplicable según AT8 cuando se requiera reasentamiento |
| **Licencia Ambiental del Proyecto** | Resolución específica emitida por ANLA | **Documento vinculante** - cumplimiento obligatorio |

### 12.5 Normativa Predial

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Ley 388 de 1997** | Ley de Desarrollo Territorial | Marco de adquisición predial y expropiación |
| **Ley 1682 de 2013** | Infraestructura de Transporte - aspectos prediales | Aplicable a adquisición de predios del proyecto |
| **Decreto 1420 de 1998** | Reglamenta expropiaciones | Procedimiento de expropiación administrativa |
| **Resolución 20217020013455 de 2021** | Declaratoria de utilidad pública del proyecto | **Específica del proyecto** - autoriza expropiaciones |

### 12.6 Normativa Social

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Constitución Política - Art. 330** | Consulta previa con comunidades étnicas | Si aplica según presencia de comunidades étnicas |
| **Ley 21 de 1991** | Convenio 169 de la OIT | Derechos de pueblos indígenas y tribales |
| **Decreto 1320 de 1998** | Reglamenta Consulta Previa | Si aplica según territorialidad |
| **Resolución 077 de 2012 - ANI** | Programa de Reasentamiento | Marco para gestión social según AT8 |

### 12.7 Normativa Técnica de Seguridad y Construcción

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **NSR-10** | Norma Sismo Resistente Colombiana (Ley 400 de 1997) | **Obligatoria** para diseño estructural de puentes y estructuras |
| **RETIE** | Reglamento Técnico de Instalaciones Eléctricas | **Obligatorio** para instalaciones eléctricas del proyecto |
| **RETILAP** | Reglamento Técnico de Iluminación y Alumbrado Público | Aplicable a iluminación de la vía |
| **Resolución 1111 de 2013 - Min. Trabajo** | Sistema de Gestión de Seguridad y Salud en el Trabajo | Obligatoria para gestión SST en construcción y operación |

### 12.8 Normativa Financiera y Tributaria

| Norma | Descripción | Aplicación al Proyecto |
|-------|-------------|------------------------|
| **Estatuto Tributario** | Código de normas tributarias | Obligaciones tributarias del Concesionario |
| **Ley 1819 de 2016** | Reforma tributaria | Impuestos aplicables al proyecto |
| **Normas contables colombianas (NIIF)** | Normas Internacionales de Información Financiera | Contabilidad del proyecto |

### 12.9 Jerarquía Normativa

**Orden de aplicación en caso de contradicción entre normas:**

1. **Constitución Política de Colombia** (supremacía constitucional)
2. **Leyes de la República** (Ley 80/1993, Ley 1508/2012, etc.)
3. **Decretos reglamentarios** (Decreto 1082/2015, etc.)
4. **Resoluciones y actos administrativos**
5. **Normativa técnica de obligatorio cumplimiento** (NSR-10, RETIE)
6. **Contrato de Concesión** (en aspectos no regulados por normas de orden público)
7. **Normativa técnica referenciada** (Manuales INVÍAS, AASHTO, etc.)

**Principio fundamental:** 
> El contrato NO puede derogar normas de orden público (seguridad, salud, medio ambiente). 
> En caso de contradicción entre el contrato y una norma de orden público, **prevalece la norma legal**.

---

## 13. GLOSARIO DE TÉRMINOS TÉCNICOS

### 13.1 Términos Contractuales Generales

| Término | Definición | Fuente |
|---------|------------|--------|
| **ANI** | Agencia Nacional de Infraestructura - Entidad contratante | Parte General - Definiciones |
| **Concesionario** | Sociedad de objeto único adjudicataria del contrato | Parte General - Definiciones |
| **Interventor/Interventoría** | Persona jurídica contratada por ANI para supervisar el contrato | Parte General - Definiciones |
| **Fecha de Inicio** | Fecha de inicio de la ejecución del contrato | Parte General - Definiciones |
| **Unidad Funcional (UF)** | División operativa del proyecto que puede operar independientemente | Parte General - Definiciones |
| **Etapa Preoperativa** | Etapa que incluye Fase de Preconstrucción y Fase de Construcción | Parte General - Definiciones |
| **Etapa de Operación y Mantenimiento** | Etapa en la que se opera y mantiene la infraestructura terminada | Parte General - Definiciones |
| **Retribución** | Pago mensual que recibe el Concesionario por O&M y disponibilidad de la vía | Parte Especial Sección 4.3 |
| **Deducción** | Reducción de la Retribución por incumplimiento de indicadores | Parte Especial Sección 4.3(c) |
| **Multa** | Sanción pecuniaria por incumplimientos contractuales | Parte Especial Sección 6.1 |

### 13.2 Términos de Unidades Funcionales

| Término | Definición | Fuente |
|---------|------------|--------|
| **UF0-D** | Unidad Funcional 0 Definitiva (214.68 km) - tramos operados permanentemente | Parte Especial - Ref. 1.206 |
| **UF0-T** | Unidad Funcional 0 Temporal (152.94 km) - pasos poblados en sitios de futuras variantes | Parte Especial - Ref. 1.206 |
| **UF0-P** | Unidad Funcional 0 Provisional (6.62 km) - pasos poblados temporales hasta construcción variantes | Parte Especial - Ref. 1.206 |
| **Acta de Terminación de UF** | Documento que certifica finalización de construcción de una Unidad Funcional | Parte General Sección 4.18 |
| **Indicadores Mínimos** | Indicadores menos exigentes aplicables a UF0 en primeros 180 días | AT4 - Tabla Indicadores Mínimos |

### 13.3 Términos Técnicos Viales

| Término | Definición | Fuente |
|---------|------------|--------|
| **IRI** | International Roughness Index - Índice de Rugosidad Internacional (m/km) | AT4 - Indicadores |
| **PCI** | Pavement Condition Index - Índice de Condición del Pavimento | AT4 - Indicadores |
| **FWD** | Falling Weight Deflectometer - Deflectómetro de Impacto | AT4 - Especificaciones de medición |
| **Rehabilitación** | Intervención para restablecer características de la vía deteriorada | AT1 |
| **Mejoramiento** | Intervención para elevar especificaciones técnicas de la vía | AT1 |
| **Puesta a Punto** | Intervenciones iniciales para llevar la vía a estándares mínimos | AT1 |
| **Mantenimiento Rutinario** | Actividades periódicas de conservación (limpieza, bacheo, etc.) | AT2 |
| **Mantenimiento Periódico** | Intervenciones programadas de mayor envergadura (rehabilitación pavimento, etc.) | AT2 |
| **Mantenimiento Extraordinario** | Intervenciones no programadas ante eventos imprevistos | AT2 |

### 13.4 Términos de Indicadores

| Término | Definición | Fuente |
|---------|------------|--------|
| **SICC** | Sistema Informático de Contabilización y Control de Indicadores | AT4 Sección 5 |
| **Índice de Cumplimiento** | Valor entre 0-100% que mide cumplimiento de indicadores de una UF | AT4 |
| **Indicadores de Estado (E1-E22)** | Miden condición física de la infraestructura | AT4 |
| **Indicadores de Operación (O1-O6)** | Miden calidad del servicio operativo | AT4 |
| **Ponderación** | Peso porcentual de cada indicador en el Índice de Cumplimiento | AT4 |
| **Declaración del Concesionario** | Reporte formal del Concesionario sobre cumplimiento de indicadores | AT4 |

### 13.5 Términos Financieros

| Término | Definición | Fuente |
|---------|------------|--------|
| **Patrimonio Autónomo** | Estructura fiduciaria para administrar recursos del proyecto | AF1 |
| **Subcuenta** | Cuenta específica dentro del Patrimonio Autónomo para un propósito determinado | AF1 |
| **Giros de Equity** | Aportes de capital que deben realizar los accionistas del Concesionario | Parte Especial Sección 4.4 |
| **Aportes ANI** | Recursos que aporta la ANI al proyecto | Parte Especial Sección 4.5 |
| **Recaudo de Peaje** | Ingresos por cobro de peaje en las estaciones del proyecto | Parte Especial Sección 4.2 |
| **Soporte de Ingresos (SI)** | Mecanismo de garantía de ingresos mínimos por parte de la ANI | Parte Especial Sección 4.6 |
| **Retribución (Ri)** | Pago mensual al Concesionario por disponibilidad y O&M | Parte Especial Sección 4.3 |
| **Cesión Especial** | Mecanismo de cesión de la Retribución a prestamistas | AF2 |

### 13.6 Términos Ambientales

| Término | Definición | Fuente |
|---------|------------|--------|
| **Licencia Ambiental** | Autorización de la autoridad ambiental para ejecutar el proyecto | Parte General - Definiciones |
| **ANLA** | Autoridad Nacional de Licencias Ambientales | AT7 |
| **PAGA** | Plan de Adaptación de la Guía Ambiental | AT7 |
| **PMA** | Plan de Manejo Ambiental | AT7 |
| **ICA** | Informe de Cumplimiento Ambiental | AT7 |
| **Plan de Trámites Ambientales** | Documento con cronograma de obtención de permisos ambientales | AT7 |
| **Compensación Ambiental** | Medidas para compensar impactos ambientales no mitigables | AT7 |

### 13.7 Términos Sociales y Prediales

| Término | Definición | Fuente |
|---------|------------|--------|
| **PGSC** | Plan de Gestión Social de la Construcción | AT8 |
| **PGAS** | Plan de Gestión del Área Social | AT8 |
| **Plan de Reasentamiento** | Programa para población que debe ser reasentada | AT8 |
| **Unidad Social** | Familia o grupo afectado por el proyecto | AT8 |
| **Predio** | Inmueble requerido para el proyecto | AT6 |
| **Faja** | Franja de terreno del corredor vial | AT6 |
| **Negociación Directa** | Compra voluntaria de predios mediante acuerdo con propietario | AT6 |
| **Expropiación Administrativa** | Procedimiento para adquirir predios cuando no hay acuerdo voluntario | AT6 |

### 13.8 Términos de Gestión Contractual

| Término | Definición | Fuente |
|---------|------------|--------|
| **Jerarquía Documental** | Orden de prelación de documentos contractuales | Sección 19.15 Parte General |
| **Obligación Implícita** | Obligación no expresada pero derivada de la naturaleza de la prestación | Código Civil Art. 1501 + Contrato |
| **Otrosí** | Modificación contractual formal | Ley 80/1993 |
| **Orden de Cambio** | Instrucción de ANI para modificar aspectos del proyecto | Parte General |
| **No Objeción** | Aprobación de la Interventoría a documentos del Concesionario | Parte General |
| **Objeción** | Rechazo de la Interventoría a documentos del Concesionario por incumplimiento | Parte General |
| **Amigable Componedor** | Mecanismo de solución de controversias previo al arbitramento | Parte General Sección 15.1 |
| **Evento Eximente de Responsabilidad (EER)** | Eventos no imputables al Concesionario que afectan cumplimiento | Parte General Sección 14.2 |

---

## 14. CONTACTOS Y ROLES CLAVE DEL PROYECTO

### 14.1 Estructura Organizacional
ANI (Agencia Nacional de Infraestructura)
├── Vicepresidencia de Gestión Contractual
├── Gerencia de Proyecto (Líder de Proyecto)
└── Área Jurídica
INTERVENTORÍA
...
CONCESIONARIO (Sociedad de Objeto Único)
├── Representante Legal
├── Gerencia de Proyecto
├── Área Técnica/Ingeniería
├── Área Legal/Contractual
├── Área Financiera
├── Gestión Ambiental
├── Gestión Social
├── Gestión Predial
└── Operación y Mantenimiento
CONSTRUCTOR/EPC (Contratista de Construcción)
├── Director de Proyecto
├── Jefe de Obra
├── Oficina Técnica
└── Equipos de Campo
...
## 15. FORMATOS Y PLANTILLAS

### 15.1 Formato de Matriz de Trazabilidad de Requisitos
MATRIZ DE TRAZABILIDAD DE REQUISITOS CONTRACTUALES
Proyecto: APP Puerto Salgar - Barrancabermeja
Componente: [Identificar componente]
Fecha: [Fecha]
IDRequisito ContractualFuente ContractualNivel JerárquicoDiseño/Ejecución PropuestaCumpleObservacionesResponsable1Ancho calzada 3.65mAT1-2.2.133.65m✓-Ing. Diseño2Velocidad diseño 100 km/hAT1-2.73100 km/h✓Excepto interseccionesIng. Diseño3Láminas reflectivas Tipo IVAT3-Cap.Señal5Tipo IV✓Cotización ajustadaIng. Especif.

### 15.2 Formato de Consulta a ANI sobre Interpretación Contractual
[MEMBRETE DEL CONCESIONARIO]
BogotÃ¡ D.C., [fecha]
Señores
AGENCIA NACIONAL DE INFRAESTRUCTURA - ANI
Gerencia de Proyecto APP Puerto Salgar - Barrancabermeja
Ciudad
ASUNTO: Consulta sobre interpretación contractual - [tema específico]
PROYECTO: APP Puerto Salgar - Barrancabermeja
Respetados señores:
I. ANTECEDENTES
[Describir la situación que genera la consulta]
II. CONTRADICCIÓN IDENTIFICADA
[Detallar los documentos que se contradicen]
DOCUMENTO A: [Identificar, citar sección exacta, nivel jerárquico]
Establece: [transcribir texto relevante]
DOCUMENTO B: [Identificar, citar sección exacta, nivel jerárquico]
Establece: [transcribir texto relevante]
III. ANÁLISIS DEL CONCESIONARIO
[Explicar análisis de jerarquía documental según Sección 19.15]
[Proponer interpretación]
IV. CONSULTA
[Formular pregunta específica solicitando concepto de ANI]
V. SOLICITUD
Se solicita concepto oficial de la ANI sobre la interpretación correcta a aplicar en este caso.
Cordialmente,
[FIRMA]
[NOMBRE]
Representante Legal
...
## 16. REFERENCIAS BIBLIOGRÁFICAS Y DOCUMENTALES

### 16.1 Documentos Contractuales del Proyecto

- Contrato de Concesión APP Puerto Salgar - Barrancabermeja - Parte General
- Contrato de Concesión APP Puerto Salgar - Barrancabermeja - Parte Especial
- Apéndice Técnico 1 - Alcance del Proyecto
- Apéndice Técnico 2 - Operación y Mantenimiento
- Apéndice Técnico 3 - Especificaciones Técnicas
- Apéndice Técnico 4 - Indicadores
- Apéndice Técnico 5 - Interferencia con Redes
- Apéndice Técnico 6 - Gestión Predial
- Apéndice Técnico 7 - Gestión Ambiental
- Apéndice Técnico 8 - Gestión Social
- Apéndice Financiero 1 - Información Financiera
- Apéndice Financiero 2 - Cesión Especial de Retribución
- Apéndice Financiero 3 - Garantías y Seguros

### 16.2 Normativa Legal Colombiana

- Ley 80 de 1993 - Estatuto General de Contratación
- Ley 1508 de 2012 - Régimen Jurídico de las APP
- Decreto 1082 de 2015 - Decreto Único Reglamentario
- Código Civil Colombiano
- Código de Comercio

### 16.3 Normativa Técnica

- Manual de Diseño Geométrico de Carreteras - INVÍAS 2008
- Especificaciones Generales de Construcción de Carreteras - INVÍAS
...
**Esta Guía Completa Contractual es un documento informativo elaborado para apoyo del equipo del proyecto APP Puerto Salgar - Barrancabermeja. La información contenida se basa en la interpretación de los documentos contractuales y la normativa colombiana aplicable.**

**IMPORTANTE:**
- Esta guía NO sustituye la consulta y análisis de los documentos contractuales originales
- Toda decisión contractual, técnica, financiera o legal debe ser respaldada por el equipo jurídico del proyecto
- En caso de contradicción entre esta guía y los documentos contractuales, prevalecen los documentos contractuales
- La jerarquía documental establecida en la Sección 19.15 de la Parte General del Contrato es vinculante y debe aplicarse estrictamente
- Se recomienda validación por equipo jurídico antes de utilizar esta información formalmente
...
**Estado:** Versión 1.0 - Documento Completo  
**Fecha de elaboración:** Septiembre 2025  
**Proyecto:** APP Puerto Salgar - Barrancabermeja (TM 01)  
**ReintentarDZContinuarEditarmarkdownPreparado por:** Administrador Contractual  
**Próxima revisión:** Ante modificaciones contractuales o normativas

---

## ANEXO A: CHECKLIST DE VERIFICACIÓN CONTRACTUAL

### A.1 Checklist para Elaboración de Estudios y Diseños
CHECKLIST DE VERIFICACIÓN CONTRACTUAL
ESTUDIOS Y DISEÑOS
Proyecto: APP Puerto Salgar - Barrancabermeja
Documento: [Nombre del estudio/diseño]
Unidad Funcional: [Identificar UF]
Fecha: [Fecha]
Responsable: [Nombre]
VERIFICACIÓN DE CUMPLIMIENTO CONTRACTUAL
□ PASO 1: IDENTIFICACIÓN DE DOCUMENTOS APLICABLES
□ Parte General - Secciones aplicables identificadas
□ Parte Especial - Secciones aplicables identificadas
□ AT1 - Alcance del Proyecto - Revisado y aplicable
□ AT2 - O&M - Revisado (si aplica)
□ AT3 - Especificaciones Técnicas - Revisado y aplicable
□ Otros AT relevantes - Identificados
□ PASO 2: JERARQUÍA DOCUMENTAL
□ Matriz de trazabilidad de requisitos elaborada
□ Verificado orden de prelación según Sección 19.15
□ Contradicciones identificadas y resueltas
□ Obligaciones implícitas identificadas
□ PASO 3: PARÁMETROS TÉCNICOS
□ Sección típica conforme a AT1-2.2.1
□ Velocidad de diseño conforme a AT1-2.7
□ Especificaciones de pavimento conforme a AT3
□ Drenaje conforme a especificaciones
□ Señalización conforme a AT2 y AT3
□ Estructuras conforme a NSR-10 y AT3
□ PASO 4: DOCUMENTACIÓN
□ Memoria Técnica incluye capítulo de Marco Contractual
□ Todas las decisiones de diseño tienen fundamento contractual
□ Referencias a documentos contractuales son exactas (sección, numeral)
□ Nivel jerárquico de cada referencia está identificado
□ PASO 5: VERIFICACIÓN CRUZADA
□ Revisión por par técnico completada
□ Revisión por área contractual/legal completada
□ Observaciones internas atendidas
□ Declaración de cumplimiento contractual incluida
□ PASO 6: PREPARACIÓN PARA ENTREGA
□ Todos los planos y anexos incluidos
□ Formato de entrega conforme a requerimientos contractuales
□ Carta de presentación elaborada
□ Radicación preparada
OBSERVACIONES:


APROBACIONES:
Elaboró: _________________ Fecha: _________
Revisó Técnico: _________________ Fecha: _________
Revisó Contractual: _________________ Fecha: _________
Aprobó: _________________ Fecha: _________

---

### A.2 Checklist para Respuesta a Observaciones de Interventoría
CHECKLIST PARA RESPUESTA A OBSERVACIONES DE INTERVENTORÍA
Proyecto: APP Puerto Salgar - Barrancabermeja
Oficio Interventoría: [Número]
Fecha recepción: [Fecha]
Plazo de respuesta: [Fecha límite]
Responsable: [Nombre]
□ PASO 1: ANÁLISIS DE OBSERVACIONES
□ Todas las observaciones leídas y comprendidas
□ Observaciones clasificadas por tipo:
□ Observaciones con fundamento contractual
□ Observaciones sin fundamento contractual claro
□ Observaciones de forma (no afectan cumplimiento técnico)
□ Impacto de cada observación evaluado
□ PASO 2: VERIFICACIÓN CONTRACTUAL
Para cada observación:
□ Documento contractual citado por Interventoría verificado
□ Nivel jerárquico del documento verificado
□ Interpretación de Interventoría analizada
□ Posición del Concesionario definida (aceptar/objetar)
□ PASO 3: PREPARACIÓN DE RESPUESTA
Para observaciones ACEPTADAS:
□ Plan de subsanación elaborado
□ Plazo de subsanación definido
□ Recursos asignados
□ Responsable designado
Para observaciones OBJETADAS:
□ Fundamento contractual de objeción identificado
□ Jerarquía documental aplicada (Sección 19.15)
□ Argumentación técnica preparada
□ Solicitud de retiro de observación formulada
□ PASO 4: REDACCIÓN DE RESPUESTA
□ Formato de oficio utilizado correctamente
□ Todas las observaciones respondidas (una por una)
□ Referencias contractuales exactas incluidas
□ Tono respetuoso pero firme en objeciones
□ Plazos comprometidos son realistas
□ PASO 5: REVISIONES INTERNAS
□ Revisión por área técnica
□ Revisión por área contractual/legal
□ Revisión por gerencia de proyecto
□ Ajustes incorporados
□ PASO 6: ENVÍO Y SEGUIMIENTO
□ Oficio radicado en plazo
□ Copia a ANI (si corresponde)
□ Seguimiento programado para verificar aceptación/rechazo
□ Plan B preparado en caso de no aceptación
OBSERVACIONES:

APROBACIONES:
Elaboró: _________________ Fecha: _________
Revisó Legal: _________________ Fecha: _________
Aprobó: _________________ Fecha: _________

---

### A.3 Checklist para Contratación de Proveedores
CHECKLIST DE VERIFICACIÓN CONTRACTUAL - PROVEEDORES
Proyecto: APP Puerto Salgar - Barrancabermeja
Proveedor: [Nombre]
Alcance: [Descripción]
Valor: [Monto]
...
□ Alcance del contrato con proveedor está claramente delimitado
□ Componente del proyecto al que pertenece identificado
□ Unidad Funcional correspondiente identificada
□ PASO 2: IDENTIFICACIÓN DE ESPECIFICACIONES CONTRACTUALES
□ Parte General revisada (si aplica)
□ Parte Especial revisada (si aplica)
□ AT1 - Alcance revisado
□ AT3 - Especificaciones Técnicas revisado
□ Otros AT relevantes revisados
□ Matriz de especificaciones contractuales elaborada
□ PASO 3: ESPECIFICACIONES DE COMPRA
□ Especificaciones de compra incluyen TODOS los requisitos contractuales
□ Referencias exactas a documentos contractuales incluidas
□ Nivel jerárquico de cada especificación identificado
□ NO hay contradicciones con documentos contractuales
□ PASO 4: EVALUACIÓN DE PROPUESTAS
□ Propuestas evaluadas contra matriz de especificaciones contractuales
□ Cumplimiento de cada especificación verificado
□ Propuestas que NO cumplen especificaciones contractuales RECHAZADAS
□ Justificación de rechazo documentada con base contractual
□ PASO 5: CONTRATO CON PROVEEDOR
□ Contrato incluye obligación de cumplir especificaciones del proyecto APP
□ Referencias a AT aplicables incluidas en contrato con proveedor
□ Cláusula de prevalencia del contrato APP sobre contrato con proveedor
□ Garantías del proveedor son adecuadas
□ PASO 6: GESTIÓN DE RIESGOS
□ Riesgo de incumplimiento contractual por propuesta del proveedor: BAJO
□ Proveedor conoce y acepta especificaciones contractuales del proyecto APP
□ Plan de contingencia en caso de incumplimiento del proveedor: DEFINIDO
OBSERVACIONES:

APROBACIONES:
Área Técnica: _________________ Fecha: _________
Área Contractual: _________________ Fecha: _________
Área Compras: _________________ Fecha: _________
Aprobó: _________________ Fecha: _________

---

## ANEXO B: FLUJOGRAMAS DE PROCESOS

### B.1 Flujograma: Resolución de Contradicciones Documentales
INICIO
↓
[Identificación de contradicción entre documentos]
↓
¿Son documentos de DIFERENTE nivel jerárquico?
↓ SÍ                                    ↓ NO
[Aplicar Sección 19.15]           [¿Son del MISMO AT?]
↓                                       ↓ SÍ        ↓ NO
[Prevalece documento                [Principio de   [Revisar si
de MAYOR jerarquía                  especialidad]  documento de
(menor número)]                        ↓           mayor jerarquía
↓                                  ¿Resuelve?     aclara]
[Documentar decisión]                   ↓ SÍ           ↓
↓                              [Aplicar más    ¿Aclara?
[Comunicar si es necesario]       específico]        ↓ SÍ
↓                                     ↓         [Aplicar
[FIN]                            [Documentar]    aclaración]
↓              ↓
...
### B.2 Flujograma: Gestión de Observaciones de Interventoría
INICIO
↓
[Recepción de oficio con observaciones de Interventoría]
↓
[Registro en sistema de gestión documental]
↓
[Identificación de plazo de respuesta]
↓
[Análisis de cada observación]
↓
¿Observación tiene fundamento contractual?
↓ SÍ                                    ↓ NO
[Verificar documento citado]        [Analizar jerarquía
↓                                  documental]
¿Es correcto el fundamento?              ↓
↓ SÍ              ↓ NO            [Preparar objeción
[ACEPTAR          [Verificar         fundamentada]
observación]      jerarquía              ↓
↓               documental]        [Citar Sección 19.15
[Elaborar plan      ↓                y documento de mayor
de subsanación] ¿Prevalece otro     jerarquía]
↓              documento?              ↓
[Definir plazo]     ↓ SÍ            [Solicitar retiro de
↓              [OBJETAR            observación]
[Asignar        observación]            ↓
responsable]        ↓                   ↓
↓              [Citar            [Redacción de oficio
...
└─────────┬────────┘              [Aprobaciones]
↓                           ↓
[Redacción de oficio            [Radicación]
de respuesta]                      ↓
↓                       [Seguimiento]
[Revisiones internas]               ↓
↓                       ¿Interventoría
[Aprobaciones]                  acepta objeción?
↓                           ↓ SÍ    ↓ NO
[Radicación]                    [FIN]   [Escalar a ANI]
↓                                   ↓
[Ejecución de plan                  [Consulta formal]
de subsanación]                          ↓
↓                           [Esperar concepto]
[Reenvío de documento                     ↓
corregido]                         [Aplicar decisión]
↓                                  ↓
[Seguimiento hasta                      [FIN]
aceptación final]
↓
[FIN]
...
### B.3 Flujograma: Identificación de Obligaciones Implícitas
INICIO
↓
[Identificación de obligación contractual explícita]
↓
[Pregunta: ¿Qué se requiere para CUMPLIR esta obligación?]
↓
[Listar actividades necesarias para cumplir]
↓
[Para cada actividad: ¿Está expresamente mencionada en el contrato?]
↓ NO                                    ↓ SÍ
[¿Es técnicamente IMPOSIBLE             [Es obligación
cumplir sin esta actividad?]             explícita]
↓ SÍ                  ↓ NO                ↓
[Es OBLIGACIÓN      [¿Es buena         [Documentar
IMPLÍCITA]          práctica de        y ejecutar]
↓                  la industria?]         ↓
[Fundamento:           ↓ SÍ             [FIN]
Código Civil       [Recomendable
Art. 1501 +        pero NO
Cláusula del       obligatoria]
Contrato]              ↓
↓                 [Evaluar
[Documentar         implementación
identificación     discrecional]
de obligación          ↓
implícita]          [FIN]
↓
[Incluir en alcance
...
## ANEXO C: CASOS DE ESTUDIO ADICIONALES

### C.1 Caso de Estudio: Gestión de Cambio de Alcance Solicitado por Interventoría

**Situación:**
La Interventoría solicita al Concesionario modificar el diseño de una intersección para incluir un carril adicional de giro a la izquierda que no está contemplado en el AT1.

**Análisis:**

1. **Verificación contractual:**
   - AT1 define el alcance del proyecto
   - La modificación propuesta NO está en el AT1
   - Constituye un cambio de alcance

2. **Marco legal:**
   - Ley 80/1993: modificaciones requieren Otrosí
   - El Concesionario no puede asumir alcances no contractuales sin compensación

3. **Análisis de jerarquía:**
   - Solicitud de Interventoría (no es documento contractual)
   - vs AT1 - Alcance del Proyecto (Nivel 3)
   - **Prevalece:** AT1

**Resolución:**

El Concesionario debe:
1. Respetuosamente rechazar la ejecución inmediata del cambio
2. Explicar que constituye modificación de alcance no prevista en AT1
3. Ofrecer evaluar técnica y económicamente el cambio
4. Indicar que la ejecución requiere Otrosí contractual
5. Ofrecer colaboración para tramitar modificación contractual si ANI lo considera pertinente

**Respuesta sugerida:**
En atención a la solicitud de modificar el diseño de la intersección [X] para incluir
un carril adicional, el Concesionario respetuosamente manifiesta:

El alcance del proyecto está definido en el AT1 - Alcance del Proyecto (Nivel 3 de
jerarquía documental), el cual no contempla este carril adicional.
La modificación solicitada constituye un CAMBIO DE ALCANCE que excede las obligaciones
contractuales del Concesionario.
Conforme a la Ley 80 de 1993 y la Ley 1508 de 2012, las modificaciones de alcance
contractual requieren la suscripción de un Otrosí entre ANI y Concesionario.
Sin perjuicio de lo anterior, el Concesionario está en disposición de:

Evaluar técnicamente la modificación propuesta
Elaborar diseño y presupuesto del cambio
Colaborar con ANI en el trámite de modificación contractual si se decide proceder


Se solicita concepto oficial de ANI sobre si se procederá con el trámite de Otrosí
para esta modificación.


---

### C.2 Caso de Estudio: Conflicto entre Especificación Contractual y Realidad de Campo

**Situación:**
El AT3 especifica que se debe utilizar material granular tipo A para subbase, pero en campo se descubre que el material disponible en la zona es tipo B, con propiedades ligeramente inferiores pero dentro de rangos aceptables de otras normas internacionales.

**Análisis:**

1. **Verificación contractual:**
   - AT3 especifica material tipo A (obligatorio)
   - Material disponible es tipo B (no cumple especificación)

2. **Opciones:**
   - **Opción A:** Importar material tipo A desde otra zona (sobrecosto, impacto ambiental)
   - **Opción B:** Solicitar modificación de especificación (requiere justificación técnica sólida)

3. **Análisis técnico:**
   - ¿Material tipo B cumple con el resultado contractual (capacidad estructural requerida)?
   - ¿Existen estudios que respalden el uso de material tipo B?
   - ¿Otras normas internacionales (AASHTO, etc.) permiten material tipo B en condiciones similares?

**Resolución:**

El Concesionario debe:

1. **NO cambiar la especificación unilateralmente**
2. Elaborar estudio técnico que demuestre:
   - Propiedades del material tipo B disponible
   - Análisis de capacidad estructural con material tipo B
   - Comparativo con material tipo A
   - Referencias a normas internacionales
   - Factibilidad de uso
3. Presentar solicitud formal a Interventoría y ANI para modificación de especificación
4. Incluir análisis de impacto (económico, ambiental, cronograma)
5. Esperar aprobación formal antes de proceder

**Comunicación sugerida:**
ASUNTO: Solicitud de modificación de especificación técnica - Material de subbase
El Concesionario solicita respetuosamente la evaluación de una modificación a la
especificación del AT3 - Capítulo de Pavimentos, por las siguientes razones:
I. ESPECIFICACIÓN ACTUAL
AT3 especifica material granular tipo A para subbase
II. SITUACIÓN IDENTIFICADA
El material disponible en la zona del proyecto es tipo B, con las siguientes
características: [detallar]
III. ANÁLISIS TÉCNICO
Se adjunta estudio técnico (Anexo 1) que demuestra:

Material tipo B cumple con capacidad estructural requerida
Norma AASHTO M-147 permite uso de material tipo B en condiciones similares
Ensayos de laboratorio confirman propiedades adecuadas

IV. BENEFICIOS DE LA MODIFICACIÓN

Reducción de costos ambientales (menor transporte)
Menor impacto ambiental
Uso de material local
No afecta resultado contractual (capacidad estructural)

V. SOLICITUD
Se solicita autorización para modificar especificación de material de subbase de
tipo A a tipo B, mediante la suscripción del correspondiente Otrosí.
Quedamos atentos a concepto técnico de la Interventoría y decisión de ANI.

---

## ANEXO D: PREGUNTAS FRECUENTES (FAQ)

### D.1 Jerarquía Documental

**P1: ¿Qué hago si encuentro una contradicción entre la Parte General y la Parte Especial?**

R: Según la Sección 19.15, la Parte General (Nivel 1) prevalece sobre la Parte Especial (Nivel 2). Debes aplicar lo establecido en la Parte General y documentar la contradicción identificada. Si genera impacto significativo, considera elevar consulta formal a ANI.

**P2: ¿Puede la Interventoría obligarme a cumplir algo que contradice el contrato?**

R: No. La Interventoría supervisa el cumplimiento del contrato, pero no puede modificar obligaciones contractuales mediante oficios. Si la Interventoría solicita algo que contradice el contrato, debes respetuosamente objetar con fundamento en la jerarquía documental (Sección 19.15) y solicitar concepto de ANI.

**P3: ¿Qué hago si un proveedor me ofrece una especificación diferente a la del AT3 pero más económica?**

R: Debes RECHAZAR la propuesta del proveedor. El AT3 (Nivel 5) prevalece sobre cualquier propuesta de proveedor. Aceptar una especificación inferior constituiría incumplimiento contractual con graves consecuencias (rechazo de Interventoría, necesidad de rehacer trabajos, multas, no cumplimiento de indicadores).

### D.2 Obligaciones Implícitas

**P4: ¿Cómo sé si algo es una obligación implícita?**

R: Aplica el "test de necesidad": ¿Es técnicamente imposible cumplir con el resultado contractual sin realizar esta actividad? Si la respuesta es SÍ, entonces es una obligación implícita. Fundamento: Código Civil Art. 1501 + cláusula de obligaciones implícitas del contrato.

**P5: ¿Puedo cobrarle a ANI los costos de obligaciones implícitas no presupuestadas inicialmente?**

R: Es complejo. Las obligaciones implícitas se entienden incluidas en el contrato desde el inicio (principio de obligaciones de la naturaleza del acto). Sin embargo, si son significativas y no eran razonablemente previsibles, podrías documentarlas y evaluar una eventual solicitud de reequilibrio económico, aunque el éxito no está garantizado. Consulta siempre con el área legal.

### D.3 Plazos e Indicadores

**P6: ¿Qué pasa si no cumplo el plazo de 180 días para Indicadores Mínimos de UF0-D?**

R: Incumplimiento contractual que puede generar:
- Multas según Parte Especial Sección 6.1
- Deducciones a la Retribución
- Reporte negativo en informes de Interventoría
- Posible impacto en relación con prestamistas/inversionistas

**P7: ¿Cuál es la diferencia entre Indicadores Mínimos e Indicadores Completos?**

R: 
- **Indicadores Mínimos:** Parámetros menos exigentes aplicables a UF0-D, UF0-T y UF0-P en los primeros 180 días desde Fecha de Inicio
- **Indicadores Completos (E1-E22, O1-O6):** Parámetros completos aplicables a UF0-D a partir de los 36 meses, y a todas las demás UF desde su terminación

### D.4 Gestión Contractual

**P8: ¿Cuánto tiempo tengo para responder a una observación de la Interventoría?**

R: Depende de cada requerimiento específico. Generalmente, la Interventoría establece un plazo en su oficio (típicamente 10-15 días hábiles). Debes cumplir estrictamente con ese plazo. Si necesitas más tiempo, solicitalo formalmente ANTES del vencimiento.

**P9: ¿Puedo iniciar obras sin tener todos los diseños aprobados por Interventoría?**

R: NO. Iniciar obras sin aprobación de diseños constituye incumplimiento contractual grave. Los diseños deben tener "no objeción" de Interventoría antes de iniciar ejecución.

**P10: ¿Qué hago si ANI demora en responder una consulta que necesito urgentemente?**

R: 
1. Envía recordatorios corteses pero firmes
2. Documenta todas las fechas de consultas y recordatorios
3. Si la demora afecta el cronograma, documenta el impacto
4. Evalúa si constituye Evento Eximente de Responsabilidad (EER)
5. Continúa con actividades que NO dependan de la respuesta

---

## CONTROL DE CAMBIOS Y ACTUALIZACIONES

Este documento debe actualizarse en los siguientes casos:

1. **Modificaciones contractuales:** Cuando se suscriban Otrosí que modifiquen disposiciones contractuales
2. **Aclaraciones oficiales de ANI:** Cuando ANI emita conceptos que aclaren interpretaciones
3. **Cambios normativos:** Cuando se modifiquen leyes, decretos o resoluciones aplicables al proyecto
4. **Lecciones aprendidas:** Incorporación de casos reales resueltos durante la ejecución del proyecto
5. **Actualización de AT:** Si se modifican o actualizan Apéndices Técnicos

**Procedimiento de actualización:**
1. Identificación de necesidad de cambio
2. Análisis de impacto de la actualización
3. Redacción de propuesta de cambio
4. Revisión por equipo jurídico
5. Aprobación por gerencia de proyecto
6. Distribución de nueva versión
7. Capacitación al equipo (si aplica)
8. Retiro de versiones anteriores
...
- Área Contractual del Concesionario
- Email: [email de contacto]
- Teléfono: [teléfono de contacto]

**Para consultas contractuales al proyecto:**
- Gerencia de Proyecto ANI
- Interventoría APP Puerto Salgar - Barrancabermeja
...
*Documento elaborado como herramienta de apoyo para el equipo del proyecto. No sustituye la consulta de documentos contractuales originales ni el asesoramiento legal especializado.*

Este es el documento completo en formato Markdown (.md) listo para ser utilizado como conocimiento base del GPT. El documento incluye:
✅ 16 secciones principales con información completa
✅ Jerarquía documental detallada con 15 niveles
✅ Casos prácticos extendidos (8 casos de estudio)
✅ Matriz de decisión rápida
✅ Procedimientos operativos por rol (6 roles detallados)
✅ Ejemplos de redacción de oficios (5 ejemplos completos)
✅ Obligaciones contractuales clave por etapa
✅ Plazos críticos del proyecto
✅ Indicadores de desempeño (E1-E22, O1-O6)
✅ Riesgos contractuales identificados (60+ riesgos)
✅ Normativa colombiana aplicable (40+ normas)
✅ Glosario de términos técnicos (80+ términos)
✅ Anexos con checklists y flujogramas
✅ Preguntas frecuentes (FAQ)
El documento tiene aproximadamente 45,000 palabras y está listo para ser guardado como archivo .md y cargado en el GPT.