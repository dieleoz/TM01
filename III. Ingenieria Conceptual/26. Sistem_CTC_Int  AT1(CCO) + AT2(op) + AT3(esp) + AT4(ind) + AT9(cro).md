...
|---|---|---|:---:|
| **Infraestructura del CCO (UF2)** | AT1, Tabla 16 | Diseño de la sala de control, videowall, puestos de operador y sistemas de respaldo (energía, HVAC).<br>- **Disponibilidad 99.0% según AT4** | ✅ Definido |
...
3. **📊 Criterios de Disponibilidad AT4:** 99.0% especificado para infraestructura CCO
...
- ✅ **AT4:** Criterios de disponibilidad 99.0% para infraestructura CCO
...
| **R-032** | **Disponibilidad 99.0%** | **Contractual** | **Media** | **Alto** | Cumplimiento AT4 requiere redundancia crítica |
